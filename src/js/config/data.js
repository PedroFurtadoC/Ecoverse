...
const ACHIEVEMENTS = [
  ...
  { id: 'minigame_perfect', icon: '⭐', title: 'Triagem Perfeita',    desc: 'Vença um minigame sem perder nenhuma vida.',                      condition: (s) => s.perfectMinigames >= 1 },
  { id: 'separates_3',      icon: '♻️', title: 'Triagem Mestre',     desc: 'Vença 3 partidas sem perder nenhuma vida.',             condition: (s) => s.perfectMinigames >= 3 },
