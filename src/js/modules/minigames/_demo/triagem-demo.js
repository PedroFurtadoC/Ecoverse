// Easter egg: minigame escondido de triagem rápida.
// Disparado pela sequência de teclas "ECO" em qualquer lugar fora de um input.
// Completar com pelo menos 60% de acertos desbloqueia a conquista "egg_triagem".
  ...
  renderShell() {
    this.container.innerHTML = `
      <section class="demo-tri">
        <p class="demo-tri__tag">🥚 Easter egg desbloqueado</p>
